...
# Date : 2023 - 29 -5 
# Goal : Play the song Frere J with for and nested list+ External speaker + NPN in GPIO15
...
p_project = "Play the song Frere J w. nested lists- External speaker with NPN - Piano notes"
p_version = "3.1"
...
compasesNotas = [['C4', 'D4', 'E4', 'C4'], # COMPAS 1
            ['C4', 'D4', 'E4', 'C4'], # COMPAS 2
            ['E4', 'F4', 'G4'], # COMPAS 3
            ['E4', 'F4', 'G4'], # COMPAS 4
            ['G4', 'A4', 'G4', 'F4', 'E4', 'C4'], # COMPAS 5
            ['G4', 'A4', 'G4', 'F4', 'E4', 'C4'], # COMPAS 6
            ['C4', 'G4', 'C4'], # COMPAS 7
            ['C4', 'G4', 'C4'] # COMPAS 8
            ]

compasesDura = [[NEGRA, NEGRA, NEGRA, NEGRA],
                [NEGRA, NEGRA, NEGRA, NEGRA],
                [NEGRA, NEGRA, BLANCA],
                [NEGRA, NEGRA, BLANCA],
                [CORCHEA, CORCHEA, CORCHEA, CORCHEA, NEGRA, NEGRA],
                [CORCHEA, CORCHEA, CORCHEA, CORCHEA, NEGRA, NEGRA],
                [NEGRA, NEGRA, BLANCA],
                [NEGRA, NEGRA, BLANCA]
                ]

for comp in range(0, len(compasesNotas)):
    for nota in range(0, len(compasesNotas[comp])):
        tone(buzzer, round(notesFreq[compasesNotas[comp][nota]]), compasesDura[comp][nota])
