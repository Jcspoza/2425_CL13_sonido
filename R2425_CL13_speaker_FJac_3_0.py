...
# Date : 2023 - 29 -5 
# Goal : Play the song Frere J 1 by 1+ External speaker + NPN in GPIO15
...
p_project = "Play the song Frere J 1x1 - External speaker with NPN - Piano notes"
p_version = "3.0"
...
BPM = 110 # Beats per minute para Frere JaqueS
...
silence(buzzer, silCompas)
# COMPAS 5
tone(buzzer,round(notesFreq['G4']),NEGRA//2)
tone(buzzer,round(notesFreq['A4']),NEGRA//2)
tone(buzzer,round(notesFreq['G4']),NEGRA//2)
tone(buzzer,round(notesFreq['F4']),NEGRA//2)
tone(buzzer,round(notesFreq['E4']),NEGRA)
tone(buzzer,round(notesFreq['C4']),NEGRA)
silence(buzzer, silCompas)
...
# COMPAS 7
tone(buzzer,round(notesFreq['C4']),NEGRA)
tone(buzzer,round(notesFreq['G4']),NEGRA)
tone(buzzer,round(notesFreq['C4']),2*NEGRA)
silence(buzzer, silCompas)
# COMPAS 8
tone(buzzer,round(notesFreq['C4']),NEGRA)
tone(buzzer,round(notesFreq['G4']),NEGRA)
